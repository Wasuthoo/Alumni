...
export default function Home() {
  return (
    <div>
      <div className="h-screen bg-gradient-to-t from-blue-700 via-cyan-500 to-indigo-300 ">
          ...
          <div className='grid grid-cols-2 gap-4'> {/*แบ่งเป็น 2 colum*/}
            ...
            <form className="bg-white bg-opacity-80 shadow-md  rounded-2xl px-8 pt-6 pb-8 mt-2 mr-5 mb-4">
                <h2 className="text-md text-center text-white font-bold bg-sky-900 rounded-xl p-2 mb-2">ค้นหาโดยภูมิภาค</h2> 
                <div className="mb-4">
